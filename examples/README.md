...
This folder contains example code for using the Dictionary API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/dictionary', {
...
response = requests.get('https://api.apiverve.com/v1/dictionary',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/dictionary");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/dictionary](https://docs.apiverve.com/ref/dictionary)
