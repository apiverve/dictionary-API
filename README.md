...
```bash
curl -X GET "https://api.apiverve.com/v1/dictionary?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/dictionary](https://docs.apiverve.com/ref/dictionary)

---

## Use Cases

Common use cases for the Dictionary API:
